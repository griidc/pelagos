      ...
      <div class="row">
        <aside class="col-lg-3">
          <div class="card card-filter">
            ...
            <Facet
                :facet-info="results.facetInfo.productTypeDescriptorInfo"
                :facet-name="facetLabels.productTypeDesc"
                v-on="$listeners"
                :formValues="formValues"
            />
            <Facet
                :facet-info="results.facetInfo.digitalResourceTypeDescriptorsInfo"
                :facet-name="facetLabels.digitalTypeDesc"
                v-on="$listeners"
                :formValues="formValues"
            />
            <Facet
                :facet-info="results.facetInfo.researchGroupInfo"
