 ...
 */
final class Version20200304215205 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE dataset_links (id INT NOT NULL, dataset_submission_id INT NOT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, url TEXT DEFAULT NULL, name TEXT DEFAULT NULL, description TEXT DEFAULT NULL, function_code TEXT DEFAULT NULL, protocol TEXT DEFAULT NULL, creation_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, modification_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
