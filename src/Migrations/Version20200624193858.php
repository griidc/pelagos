...
final class Version20200624193858 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT NOT NULL, fileset_id INT NOT NULL, uploaded_by_id INT DEFAULT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, file_path_name TEXT DEFAULT NULL, file_size BIGINT DEFAULT NULL, file_sha256_hash TEXT DEFAULT NULL, uploaded_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, description TEXT DEFAULT NULL, physical_file_path TEXT DEFAULT NULL, status TEXT NOT NULL, creation_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, modification_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
