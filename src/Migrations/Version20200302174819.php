...
final class Version20200302174819 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dataset_submission ADD dataset_file_sha256_hash TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE dataset_submission ADD dataset_file_cold_storage_archive_sha256_hash TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE dataset_submission ADD metadata_file_sha256_hash TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE dataset_submission DROP dataset_file_sha256hash');
        $this->addSql('ALTER TABLE dataset_submission DROP metadata_file_sha256hash');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dataset_submission ADD dataset_file_sha256hash TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE dataset_submission ADD metadata_file_sha256hash TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE dataset_submission ADD dataset_file_cold_storage_archive_sha256hash TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE dataset_submission DROP dataset_file_sha256_hash');
        $this->addSql('ALTER TABLE dataset_submission DROP dataset_file_cold_storage_archive_sha256_hash');
