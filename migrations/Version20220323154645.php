 ...
 */
final class Version20220323154645 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE information_product_type (id INT NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
    }
