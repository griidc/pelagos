 ...
 */
final class Version20220419191205 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Add Information Product Type Descriptors';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE product_type_descriptor_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE information_product_product_type_descriptor (information_product_id INT NOT NULL, product_type_descriptor_id INT NOT NULL, PRIMARY KEY(information_product_id, product_type_descriptor_id))');
        $this->addSql('CREATE INDEX IDX_AC2D5B5468C0853 ON information_product_product_type_descriptor (information_product_id)');
        $this->addSql('CREATE INDEX IDX_AC2D5B5809A0F0C ON information_product_product_type_descriptor (product_type_descriptor_id)');
        ...
        $this->addSql('CREATE TABLE product_type_descriptor (id INT NOT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, creation_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, modification_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2C1AA5BA61220EA6 ON product_type_descriptor (creator_id)');
        $this->addSql('CREATE INDEX IDX_2C1AA5BAD079F553 ON product_type_descriptor (modifier_id)');
        ...
        $this->addSql('ALTER TABLE information_product_product_type_descriptor ADD CONSTRAINT FK_AC2D5B5468C0853 FOREIGN KEY (information_product_id) REFERENCES information_product (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE information_product_product_type_descriptor ADD CONSTRAINT FK_AC2D5B5809A0F0C FOREIGN KEY (product_type_descriptor_id) REFERENCES product_type_descriptor (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE product_type_descriptor ADD CONSTRAINT FK_2C1AA5BA61220EA6 FOREIGN KEY (creator_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE product_type_descriptor ADD CONSTRAINT FK_2C1AA5BAD079F553 FOREIGN KEY (modifier_id) REFERENCES person (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE information_product_product_type_descriptor DROP CONSTRAINT FK_AC2D5B5809A0F0C');
        $this->addSql('DROP SEQUENCE digital_resource_type_descriptor_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE product_type_descriptor_id_seq CASCADE');
        $this->addSql('DROP TABLE digital_resource_type_descriptor');
        $this->addSql('DROP TABLE information_product_product_type_descriptor');
        $this->addSql('DROP TABLE information_product_digital_resource_type_descriptor');
        $this->addSql('DROP TABLE product_type_descriptor');
    }
}
