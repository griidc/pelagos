...
class TimePeriod
{
	public function __construct($instanceType,$instanceName)
	{
		...
		echo '<input type="text" id="TM1_'.$instanceName.'" name="'.$instanceType.'-gml:description-gco:CharacterString"/><br/>';
		
		echo '<label for="TM2_'.$instanceName.'">beginPosition</label>';
		echo '<input type="text" id="TM2_'.$instanceName.'" name="'.$instanceType.'-gml:beginPosition-gco:date"/><br/>';
		
		echo '<label for="TM3_'.$instanceName.'">endPosition</label>';
		echo '<input type="text" id="TM3_'.$instanceName.'" name="'.$instanceType.'-gml:endPosition-gco:date"/><br/>';
