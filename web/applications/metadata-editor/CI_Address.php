...
class CI_Address
{
	...
	public function __construct($mMD, $instanceType, $instanceName, $xmlArray, $onlineresource=false)
	{
		...
		$twigArr = array('instanceName' => $instanceName, 'instanceType' => $instanceType, 'onlineresource' => $onlineresource, 'instanceVars' => $instanceVars,'isoCountries' => $this->isoCountries, 'xmlArray' => $xmlArray["gmd:CI_Address"]);
