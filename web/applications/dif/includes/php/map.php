...
function closethis(name){ gob(name).style.visibility = 'hidden'; }
function showthis(name){gob(name).style.visibility = 'visible';}
...
function counter(num){ return adder = adder + num; }
...
//                             ZOOM MAP CONTROLS                                 //
///////////////////////////////////////////////////////////////////////////////////
function mapzoom(){ var mapZoom = map.getZoom(); gob("myzoom").value = mapZoom; }
...
function logCode3(){
    if (notext === true) return;
    var code = "";
    var kmltext = 'ipolygon with hole';
...
#presenter {
    ...
    -ms-filter:<94>alpha(opacity=70)<94>;
    -moz-opacity:0.7;
    KHTMLOpacity: 0.7;
    MozOpacity: 0.7;
    -khtml-opacity:.70;
...
<div id="header">
    ...
    <div id="middlerow">
        ...
        <option>LngLat mousemove</option><option selected="selected">LatLng mousemove</option>
        </select>
...
<div id="buttonrow">
    ...
    <div class="topbutton"><INPUT TYPE="image" SRC="images/next.png" onclick="nextshape();" value="Next shape"/></div>
    <div class="topbutton"><INPUT TYPE="image" SRC="images/clear.png" onclick="clearMap();" value="Clear Map"/></div>
 <form style="margin-right:5px" action="#" onsubmit="showAddress(this.address.value); return false">
    <input type="text" style="border: 1px solid #000000;" size="50" name="address" value="Florida" />
    <INPUT TYPE="image" SRC="images/arrow.png" value="Search">     
</form>
</div>
...
<div id="presenter">
    ...
    <input type="hidden" name="showcodemode" id="presentcode" value="yes" onclick="showCodeintextarea();" checked="checked"/>
<textarea id="coords1" cols="20" rows="9">
