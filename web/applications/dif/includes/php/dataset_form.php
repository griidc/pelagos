...
<p><labelbr for="cprovisions"> <b>If Dataset Type is Video, Please Provide Video Attributes:</b> <span  style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo7_tip')"> <IMG SRC="/dif/images/info.png"> </span> </label><br />
...
<p><fieldset><labelbr for="csize"> <b><em>* </em>Approximate Size:</b> <span style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo8_tip')"> <IMG SRC="/dif/images/info.png"> </span> </label><br /> 
...
<p><fieldset> <labelbr for="coberservations"> <b>Phenomenon/Variables Being Measured or Sampled:</b> <span  style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo9_tip')"> <IMG SRC="/dif/images/info.png"> </span> </label><br />
...
<p><fieldset><labelbr for="capproach"> <b> Approach to Aquiring or Creating the Data: </b> <span style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo10_tip')"> <IMG SRC="/dif/images/info.png"> </span> </label><br />
...
<p><fieldset><labelbr for="cdate"> <span style="float:right; class="tooltip" class="tooltip" onmouseover="tooltip.add(this, 'demo11_tip')"> <IMG SRC="/dif/images/info.png"> </span> <b>Sampling Data Generation:</b> </label>
...
<p><fieldset><labelbr for="chistoric"> <b>If Using Historic Data, Please List References: </b> <span  style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo13_tip')"> <IMG SRC="/dif/images/info.png"></span></label><br />
...
<p><fieldset><labelbr for="ced"> <span style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo14_tip')"> <IMG SRC="/dif/images/info.png"> </span> <b>Metadata Editor to be Used:</b> </label><br /> 
...
<TABLE WIDTH="100%"><TR><TD>
<p><fieldset><labelbr for="cstandards"> <b>Metadata Standards:</b> <span style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo15_tip')"> <IMG SRC="/dif/images/info.png"> </span> </label><br /> 
