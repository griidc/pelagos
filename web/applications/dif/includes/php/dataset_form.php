...
<?PHP if ($status != 0){echo "<div STYLE=text-align:right><a href=dif><IMG SRC=/dif/images/button.png></A></div>"; }?>
 ...
 <?PHP }else{ ?>
 <p><fieldset> <label for="ctask"><em>*</em>Task Title: <span style="float:right;" class="tooltip" onmouseover="tooltip.add(this, 'demo1_tip')"> <IMG SRC="/dif/images/info.png"> </span> </label>
<select name=task style="width:800px;"  id="cctask" <?PHP if ($status != 0){echo "disabled";} ?>  class="required" >
...
<b>References to Historical Data to Use (if applicable): </b> <span  style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo13_tip')"> <IMG SRC="/dif/images/info.png"></span></label><br />
...
</TD><TD>&nbsp;&nbsp;&nbsp;</TD><TD> <p><fieldset><labelbr for="caccess"> <b>Data Access Point: </b> <span style="float:right; class="tooltip" onmouseover="tooltip.add(this, 'demo16_tip')"> <IMG SRC="/dif/images/info.png"> </span></label><br />
