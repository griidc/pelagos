...
<style type="text/css">
//labelbr{}
//label.error { float: none; color: red; padding-left: .1em; vertical-align: middle; }
...
or die ("Something went wrong --> " . pg_last_error($connection)); 
...
####################################################################
mail("Julie.Lann@tamucc.edu", "[New dataset]-Submitted by $firstName $lastName", "Congratulations!!!! You have just received important information about\n\ni$title $q.\n\n REVIEW: \n".$sql."\n\nHeader Table:\n".$sql2."\n\nThank You,\nRobot Jew-Lee\n", "From: jew_lee@hotmail.com\n");
$status=0;
$flag="";
####################################################################
