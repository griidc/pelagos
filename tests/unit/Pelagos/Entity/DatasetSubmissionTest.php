...
class DatasetSubmissionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test Setting of hard drive file size.
     *
     * @return void
     */
    public function testCanSetHardDriveFileSize()
    {
        $hardDriveFileSize = '5 TB';
        $this->datasetSubmission->setHarddriveFileSize($hardDriveFileSize);
        $this->assertEquals(
            $hardDriveFileSize,
            $this->datasetSubmission->getHarddriveFileSize()
        );
    }

    /**
     * Test Setting of hard drive Addressee name.
     *
     * @return void
     */
    public function testCanSetHardDriveAddresseeName()
    {
        $hardDriveAddresseeName = 'John Xyz';
        $this->datasetSubmission->setHarddriveAddresseeName($hardDriveAddresseeName);
        $this->assertEquals(
            $hardDriveAddresseeName,
            $this->datasetSubmission->getHarddriveAddresseeName()
        );
    }

    /**
     * Test Setting of hard drive Addressee email.
     *
     * @return void
     */
    public function testCanSetHardDriveAddresseeEmail()
    {
        $hardDriveAddresseeEmail = 'john@abc.com';
        $this->datasetSubmission->setHarddriveAddresseeEmail($hardDriveAddresseeEmail);
        $this->assertEquals(
            $hardDriveAddresseeEmail,
            $this->datasetSubmission->getHarddriveAddresseeEmail()
        );
    }

    /**
     * Test Setting of hard drive Addressee phone.
     *
     * @return void
     */
    public function testCanSetHardDriveAddresseePhone()
    {
        $hardDriveAddresseePhone = '123-456-7890';
        $this->datasetSubmission->setHarddriveAddresseePhone($hardDriveAddresseePhone);
        $this->assertEquals(
            $hardDriveAddresseePhone,
            $this->datasetSubmission->getHarddriveAddresseePhone()
        );
    }

    /**
     * Test Setting of hard drive Delivery Address.
     *
     * @return void
     */
    public function testCanSetHardDriveDeliveryAddress()
    {
        $hardDriveDeliveryAddress = '123 XYZ St, RandomCity, TX 12345';
        $this->datasetSubmission->setHarddriveDeliveryAddress($hardDriveDeliveryAddress);
        $this->assertEquals(
            $hardDriveDeliveryAddress,
            $this->datasetSubmission->getHarddriveDeliveryAddress()
        );
    }
}
