...
DROP TRIGGER IF EXISTS udf_person_token_delete_trigger
   ON person_token;
DROP TRIGGER IF EXISTS udf_person_token_insert_trigger
   ON person_token;
DROP TRIGGER IF EXISTS udf_person_token_update_trigger
   ON person_token;
