...
public class RisInstDeptPeopleErrorCollection {
	...
	public synchronized InstitutionDepartmentRep addInstitution(
		...
		try {
			...
			this.currentInstitutionDepartmentRep = temp;
			if(RisInstDeptPeopleErrorCollection.isDebug()) System.out.println("RisInstDeptPeopleErrorCollection.added Institution: " + institutionId);
			return temp;
		}
	}
	...
	public synchronized DepartmentPeopleRep addDepartment(int institutionId,
		...
		if(RisInstDeptPeopleErrorCollection.isDebug()) System.out.println("RisInstDeptPeopleErrorCollection.added Department : " + departmentId + " to institution: " + institutionId);
	...
	public synchronized Integer addPerson(int institutionId, int departmentId,
		...
		Integer result =  this.currentDepartmentPeopleRep.addPerson(personId);
		if(RisInstDeptPeopleErrorCollection.isDebug()) System.out.println("RisInstDeptPeopleErrorCollection.added Person: " + personId + " to Department : " + departmentId + " in institution: " + institutionId);
		return result;
	}
