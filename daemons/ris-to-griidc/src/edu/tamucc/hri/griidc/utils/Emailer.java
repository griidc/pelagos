...
public final class Emailer {
	...
	public static void main(String[] args) {
		...
		try {
			String[] risErrorLogRecipients = GriidcConfiguration.getRisErrorMsgLogRecipients();
			String[] primaryLogRecipients = GriidcConfiguration.getPrimaryMsgLogRecipients();
	...
	public void sendEmail(String fromEmailAddr, String[] toEmailAddr,
		...
		// name and password.
		Properties emailConfigProperties = GriidcConfiguration.getEmailProperties();
