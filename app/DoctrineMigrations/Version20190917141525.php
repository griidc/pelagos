 ...
 */
final class Version20190917141525 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE file (id INT NOT NULL, uploaded_by_id INT DEFAULT NULL, fileset_id INT NOT NULL, creator_id INT DEFAULT NULL, modifier_id INT DEFAULT NULL, file_name TEXT DEFAULT NULL, file_size BIGINT DEFAULT NULL, file_sha256hash TEXT DEFAULT NULL, uploaded_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL, description TEXT DEFAULT NULL, file_path TEXT DEFAULT NULL, creation_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, modification_time_stamp TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE dataset_submission_audit ADD fileset_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dataset_submission_audit DROP fileset_id');
    }
}
