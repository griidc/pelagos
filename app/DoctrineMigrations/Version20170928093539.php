...
class Version20170928093539 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE SEQUENCE log_action_item_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP SEQUENCE log_action_item_id_seq CASCADE');
        $this->addSql('DROP INDEX IDX_3543E2B861220EA6');
        $this->addSql('DROP INDEX IDX_3543E2B8D079F553');
