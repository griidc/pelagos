 ...
 */
class Version20190131170501 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE dataset_submission ADD dataset_file_url_last_checked_date TIMESTAMP(0) WITH TIME ZONE NOT NULL');
