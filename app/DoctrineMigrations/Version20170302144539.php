...
class Version20170302144539 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('UPDATE dataset_submission SET primary_dataset_contact_id = SELECT id FROM person_dataset_submission WHERE discr = \'persondatasetsubmissiondatasetcontact\' AND data_submission_id = dataset_submission.id');
    }
